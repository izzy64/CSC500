...
print("Welcome valued customer! What is your name?")
customer_name = input()

print(f"Thank you for shopping with us {customer_name}. What is today's date?")
todays_date = input()

cart = ShoppingCart(customer_name, todays_date)
print_menu(cart) # creating the cart
